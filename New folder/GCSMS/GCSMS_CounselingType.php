            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                        <?php 
                            include ('GCSMS_connection.php'); $con = mysqli_connect("localhost","root","","pupqcdb");
                        ...
                        <tbody>
                            <?php
                                ...
                                {
                                    echo "<tr>";
                                        echo "<td>".$counsType['Couns_TYPE']."</td>";
                                        echo "<td>".$counsType['Couns_TYPE_STAT']."</td>";
