...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2018 at 04:12 PM
...
INSERT INTO `r_civil_stat` (`Stud_CIVIL_STATUS`, `Stud_CS_STAT`) VALUES
('married', 'Active'),
('Single', 'Active');
...
INSERT INTO `r_couns_appointment_type` (`Appmnt_TYPE`, `Appmnt_STAT`) VALUES
('Referral', 'Active'),
('Walk In', 'Active');
...
INSERT INTO `r_couns_approach` (`Couns_APPROACH`, `Couns_APPROACH_DESC`, `Couns_APPROACH_STAT`) VALUES
('Behavioral Therapy', 'basta dun.', 'Active'),
('Psychological Theraphy', 'counselling in the mind.', 'Active');
...
INSERT INTO `r_couns_type` (`Couns_TYPE`, `Couns_TYPE_STAT`) VALUES
('Individual', 'Active');
...
--
-- Dumping data for table `r_remarks`
--

INSERT INTO `r_remarks` (`Remarks_TYPE`, `Remarks_DESC`, `Remarks_STAT`) VALUES
('julie', 'julile', 'Active'),
('resnera', 'resnera', 'Active'),
...
INSERT INTO `r_visit` (`Visit_TYPE`, `Visit_DESC`, `Visit_STAT`) VALUES
('Counselling', 'Students who needs counselling', 'Active'),
('Signing of Clearance', 'for clearance', 'Active');
