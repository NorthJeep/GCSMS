...
<head>
    ...
    <title>Counseling Approach</title>
                            ...
                            <div class="position-center">
                                <form action="GCSMS_CounselingApproach.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <label for="approachDesc">Approach Description</label>
                    ...
                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tbody>
                            <?php
                                ...
                                {
                                    echo "<tr>";
                                        echo "<td>".$approach['Couns_APPROACH']."</td>";
                                        echo "<td>".$approach['Couns_APPROACH_DESC']."</td>";
                                        echo "<td>".$approach['Couns_APPROACH_STAT']."</td>";
