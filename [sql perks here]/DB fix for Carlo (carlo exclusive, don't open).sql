...
--
-- Host: localhost
-- Generation Time: May 24, 2018 at 05:17 AM
...
Batch_ID`,
`Batch_CODE
`, `Batch_YEAR`, `Batch_DESC`, `Batch_DISPLAY_STAT`) VALUES
...
(
  `Stud_CIVIL_STATUS_ID` int
(11) NOT NULL,
  `Stud_CIVIL_STATUS` varchar
(15) NOT NULL,
  `Stud_CIVIL_STATUS_STAT` enum
('Active','Inactive') DEFAULT 'Active'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
--
...
Stud_CIVIL_STATUS_ID`,
`Stud_CIVIL_STATUS
`, `Stud_CIVIL_STATUS_STAT`) VALUES
(1, 'Single', 'Active'),
(2, 'Married', 'Active');
-- --------------------------------------------------------
--
...
(
  `Couns_APPROACH_ID` int
(11) NOT NULL,
  `Couns_APPROACH` varchar
(50) NOT NULL,
...
Course_ID`,
`Course_CODE
`, `Course_NAME`, `Course_DESC`, `Course_CURR_YEAR`, `Course_DATE_MOD`, `Course_DATE_ADD`, `Course_DISPLAY_STAT`) VALUES
...
(
  `DesOffDetails_ID` int
(11) NOT NULL,
  `DesOffDetails_CODE` varchar
(15) NOT NULL,
  `DesOffDetails_NAME` varchar
(100) NOT NULL,
  `DesOffDetails_DESC` varchar
(100) NOT NULL,
  ...
  `DesOffDetails_DISPLAY_STAT` enum
('Active','Inactive') DEFAULT 'Active'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
-- --------------------------------------------------------
--
...
(
  `Counselor_ID` int
(11) NOT NULL,
  `Counselor_CODE` varchar
(15) NOT NULL,
  `Counselor_FNAME` varchar
(100) NOT NULL,
  `Counselor_MNAME` varchar
(100) NOT NULL,
  `Counselor_LNAME` varchar
(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
--
...
Counselor_ID`,
`Counselor_CODE
`, `Counselor_FNAME`, `Counselor_MNAME`, `Counselor_LNAME`) VALUES
...
(
  `SancDetails_ID` int
(11) NOT NULL,
  `SancDetails_CODE` varchar
(100) NOT NULL,
  `SancDetails_NAME` varchar
(100) NOT NULL,
  `SancDetails_DESC` varchar
(1000) DEFAULT 'Sanction Description',
  `SancDetails_TIMEVAL` int
...
(
  `Educ_BG_ID` int
(11) NOT NULL,
  `Stud_NO_REFERENCE` varchar
(15) NOT NULL,
  `Educ_NATURE_OF_SCHOOLING` enum
('Continuous','Interrupted') DEFAULT 'Continuous',
...
(11) NOT NULL,
  `Educ_LEVEL` enum
('Pre-elementary','Elementary','High School','Vocational','College if any') NOT NULL,
...
(15) NOT NULL,
  `FamilyBG_INFO` enum
('Father','Mother','Guardian') NOT NULL,
  `Info_FNAME` varchar
(100) NOT NULL,
  `Info_MNAME` varchar
(100) NOT NULL,
...
(
  `Stud_NO` varchar
(15) NOT NULL,
  `Gen_Info_DETAILS` enum
('Favorite Subject/s','Subject/s Least Like','Club','Hobbies','Organization') NOT NULL,
...
(15) NOT NULL,
  `Received_TYPE` enum
('Honors Received','Special Awards') DEFAULT 'Honors Received',
...
Stud_ID`,
`Stud_NO
`, `Stud_FNAME`, `Stud_MNAME`, `Stud_LNAME`, `Stud_GENDER`, `Stud_COURSE`, `Stud_YEAR_LEVEL`, `Stud_SECTION`, `Stud_BIRTH_DATE`, `Stud_CITY_ADDRESS`, `Stud_PROVINCIAL_ADDRESS`, `Stud_TELEPHONE_NO`, `Stud_MOBILE_NO`, `Stud_EMAIL`, `Stud_BIRTH_PLACE`, `Stud_STATUS`, `Stud_DATE_MOD`, `Stud_DATE_ADD`, `Stud_DATE_DEACTIVATE`, `Stud_DISPLAY_STATUS`) VALUES
...
(
  `Stud_NO_REFERENCE` varchar
(15) NOT NULL,
  `PsychRec_PREV_CONSULTED` enum
('Psychiatrist','Psychologist','Counselor') NOT NULL,
...
(11) NOT NULL,
  `Upload_FILE_CATEGORY` varchar
(100) NOT NULL,
  `Upload_CATEGORY_STAT` enum
('Active','Inactive') DEFAULT 'Active'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
--
...
(50) NOT NULL,
  `Users_REFERENCED` varchar
(15) NOT NULL,
  `Users_PASSWORD` blob NOT NULL,
  `Users_ROLES` enum
('System Administrator','Administrator','OSAS HEAD','Guidance Counselor','Organization','Student','Student Assistant') NOT NULL,
...
Users_ID`,
`Users_USERNAME
`, `Users_REFERENCED`, `Users_PASSWORD`, `Users_ROLES`, `Users_PROFILE_PATH`, `Users_DATE_ADD`, `Users_DATE_MOD`, `Users_DISPLAY_STAT`) VALUES
...
Visit_ID`,
`Visit_TYPE
`, `Visit_DESC`, `Visit_TYPE_STAT`) VALUES
...
(
  `AssSancStudStudent_ID` int
(11) NOT NULL,
  `AssSancStudStudent_STUD_NO` varchar
(15) NOT NULL,
  `AssSancStudStudent_SancDetails_CODE` varchar
(15) NOT NULL,
  `AssSancStudStudent_DesOffDetails_CODE` varchar
(15) NOT NULL,
  `AssSancStudStudent_CONSUMED_HOURS` int
(11) DEFAULT '0',
  `AssSancStudStudent_REMARKS` varchar
(100) DEFAULT NULL,
  `AssSancStudStudent_IS_FINISH` enum
('Processing','Finished') NOT NULL DEFAULT 'Processing',
...
(11) NOT NULL,
  `Couns_CODE` varchar
(15) NOT NULL,
  `Visit_ID_REFERENCE` int
(11) NOT NULL,
  `Couns_DATE` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Couns_COUNSELING_TYPE` varchar
(50) NOT NULL,
  `Couns_APPOINTMENT_TYPE` varchar
(25) NOT NULL,
  `Nature_Of_Case` varchar
(50) DEFAULT NULL,
...
Couns_ID`,
`Couns_CODE
`, `Visit_ID_REFERENCE`, `Couns_DATE`, `Couns_COUNSELING_TYPE`, `Couns_APPOINTMENT_TYPE`, `Nature_Of_Case`, `Couns_BACKGROUND`, `Couns_GOALS`, `Couns_COMMENT`, `Couns_RECOMMENDATION`) VALUES
...
Couns_ID_REFERENCE`,
`Stud_NO
`, `Couns_REMARKS`, `Couns_REMARKS_DETAILS`) VALUES
...
Stud_VISIT_ID`,
`Visit_CODE
`, `Visit_DATE`, `Stud_NO`, `Visit_PURPOSE`, `Visit_DETAILS`) VALUES
...
(200) NOT NULL,
  `Upload_CATEGORY` varchar
(100) NOT NULL,
  `Upload_TYPE` varchar
(15) NOT NULL,
  `Upload_FILETYPE` varchar
(100) NOT NULL,
  `Upload_FILEPATH` varchar
(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
-- --------------------------------------------------------
--
...
select `c
`.`Couns_CODE` AS `COUNSELING_CODE`,date_format
...
`.`Couns_APPROACH` separator ', ') from `t_couns_approach` `a` where
...
select `r_stud_profile
`.`Stud_NO` AS `STUD_NO`,concat
...
select `v
`.`Visit_CODE` AS `Visit_CODE`,`v`.`Visit_DATE` AS `Visit_DATE`,`s`.`Stud_NO` AS `Stud_NO`,concat
...
--
ALTER TABLE `r_courses`
ADD CONSTRAINT `FK_Course_CURR_YEAR` FOREIGN KEY
(`Course_CURR_YEAR`) REFERENCES `r_batch_details`
(`Batch_YEAR`) ON
DELETE CASCADE ON
UPDATE CASCADE;
--
...
--
ALTER TABLE `r_stud_educ_background`
ADD CONSTRAINT `FK_edcbckgrndrfrnc_STUD_NO` FOREIGN KEY
...
--
ALTER TABLE `r_stud_educ_bg_details`
ADD CONSTRAINT `FK_stdedcbgdtlsedcbg_ID` FOREIGN KEY
...
--
ALTER TABLE `r_stud_family_bg_details`
ADD CONSTRAINT `FK_stdfmlybckgrndrfrnc_STUD_NO` FOREIGN KEY
(`Stud_NO_REFERENCE`) REFERENCES `r_stud_profile`
(`Stud_NO`) ON
DELETE CASCADE ON
UPDATE CASCADE;
...
--
ALTER TABLE `r_stud_general_info`
ADD CONSTRAINT `FK_gnrlinf_STUD_NO` FOREIGN KEY
...
--
ALTER TABLE `r_stud_honors_awards`
ADD CONSTRAINT `FK_hnrsawrds_STUD_NO` FOREIGN KEY
(`Stud_NO_REFERENCE`) REFERENCES `r_stud_profile`
(`Stud_NO`) ON
DELETE CASCADE ON
UPDATE CASCADE,
...
--
ALTER TABLE `r_stud_org_position`
ADD CONSTRAINT `FK_orgpstn_STUD_NO` FOREIGN KEY
(`Stud_NO_REFERENCE`) REFERENCES `r_stud_profile`
(`Stud_NO`) ON
DELETE CASCADE ON
UPDATE CASCADE;
...
--
ALTER TABLE `r_stud_personal_info`
ADD CONSTRAINT `FK_stdprsnlnfcvlsttrfrnc` FOREIGN KEY
(`Stud_CIVIL_STAT`) REFERENCES `r_civil_stat`
(`Stud_CIVIL_STATUS`) ON
DELETE CASCADE ON
UPDATE CASCADE,
...
--
ALTER TABLE `r_stud_phys_rec`
ADD CONSTRAINT `FK_physrc_STUD_NO` FOREIGN KEY
(`Stud_NO_REFERENCE`) REFERENCES `r_stud_profile`
(`Stud_NO`) ON
DELETE CASCADE ON
UPDATE CASCADE;
...
--
ALTER TABLE `r_stud_profile`
ADD CONSTRAINT `FK_COURSE` FOREIGN KEY
(`Stud_COURSE`) REFERENCES `r_courses`
(`Course_CODE`) ON
DELETE CASCADE ON
UPDATE CASCADE;
--
...
--
ALTER TABLE `r_stud_psych_rec`
ADD CONSTRAINT `FK_psychrc_STUD_NO` FOREIGN KEY
(`Stud_NO_REFERENCE`) REFERENCES `r_stud_profile`
(`Stud_NO`) ON
DELETE CASCADE ON
UPDATE CASCADE;
...
--
ALTER TABLE `t_assign_stud_saction`
ADD CONSTRAINT `FK_AssSancStudStudent_DesOffDetails_CODE` FOREIGN KEY
(`AssSancStudStudent_DesOffDetails_CODE`) REFERENCES `r_designated_offices_details`
(`DesOffDetails_CODE`) ON
DELETE CASCADE ON
UPDATE CASCADE,
...
--
ALTER TABLE `t_counseling`
ADD CONSTRAINT `FK_C_CT_REFERENCE` FOREIGN KEY
(`Couns_COUNSELING_TYPE`) REFERENCES `r_couns_type`
(`Couns_TYPE`) ON
DELETE CASCADE ON
UPDATE CASCADE,
...
--
ALTER TABLE `t_couns_approach`
ADD CONSTRAINT `FK_C_CA_REFERENCE` FOREIGN KEY
(`Couns_APPROACH`) REFERENCES `r_couns_approach`
(`Couns_APPROACH`) ON
DELETE CASCADE ON
UPDATE CASCADE,
...
--
ALTER TABLE `t_couns_details`
ADD CONSTRAINT `FK_CnsIDrfrnc` FOREIGN KEY
(`Couns_ID_REFERENCE`) REFERENCES `t_counseling`
(`Couns_ID`) ON
DELETE CASCADE ON
UPDATE CASCADE,
...
--
ALTER TABLE `t_stud_visit`
ADD CONSTRAINT `FK_stdvstprps_vstrfrnc` FOREIGN KEY
(`Visit_PURPOSE`) REFERENCES `r_visit`
(`Visit_TYPE`) ON
DELETE CASCADE ON
UPDATE CASCADE,
...
--
ALTER TABLE `t_upload`
ADD CONSTRAINT `FK_pldctgryrfrnc` FOREIGN KEY
(`Upload_CATEGORY`) REFERENCES `r_upload_category`
(`Upload_FILE_CATEGORY`) ON
DELETE CASCADE ON
UPDATE CASCADE;
COMMIT;
